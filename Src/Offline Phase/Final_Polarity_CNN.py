...
def f1(y_true, y_pred):
    import pdb; pdb.set_trace()
    result = keras_metrics.sparse_categorical_average_recall(y_true, y_pred)
    return result
...
print('')
print('================================================================================================')
print('CNN+WordEmbeding+MonogramFeatures')
...
print('')
print('================================================================================================')
print('CNN+WordEmbeding+BigramFeatures')
print("Getting Predictions1")
predictions1, model = getPredictions(x_train, x_test, train_labels, test_labels)
result1 = precision_recall_fscore_support(test_labels, np.round(predictions1))
...
print('')
print('================================================================================================')
print('CNN+WordEmbeding+TrigramFeatures')
print("Getting Predictions1")
predictions1, model = getPredictions(x_train, x_test, train_labels, test_labels)
result1 = precision_recall_fscore_support(test_labels, np.round(predictions1))
