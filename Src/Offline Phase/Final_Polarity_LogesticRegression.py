# -*- coding: utf-8 -*-
"""
Created on Sat Nov  2 09:28:29 2019
...
print('')
print('================================================================================================')
print('LogisticRegression+FrequenceFeatures')
...
print('')
print('================================================================================================')
print('LogisticRegression+BigramFeatures')
classifier = LogisticRegression(multi_class='multinomial', solver='newton-cg')
...
print('')
print('================================================================================================')
print('LogisticRegression+TrigramFeatures')
classifier = LogisticRegression(multi_class='multinomial', solver='newton-cg')
...
print('')
print('================================================================================================')
print('LogisticRegression+FrequenceFeatures+BigramFeatures+TrigramFeatures')
classifier = LogisticRegression(multi_class='multinomial', solver='newton-cg')
...
# Save Models
joblib.dump(vectorizer0, 'Polarity_vectorizer0.pkl') 
joblib.dump(vectorizer1, 'Polarity_vectorizer1.pkl') 
joblib.dump(vectorizer2, 'Polarity_vectorizer2.pkl') 
classifier = LogisticRegression(multi_class='multinomial', solver='newton-cg')
model = classifier.fit(features, train_labels)
