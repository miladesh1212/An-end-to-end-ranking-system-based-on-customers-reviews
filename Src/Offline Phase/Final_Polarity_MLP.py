...
print('')
print('================================================================================================')
print('MLP+FrequenceFeatures')
classifier = MLPClassifier(solver='lbfgs', alpha=1e-5,hidden_layer_sizes=(110), random_state=1)
...
print('')
print('================================================================================================')
print('MLP+FrequenceFeatures+BigramFeatures+TrigramFeatures')
classifier = MLPClassifier(solver='lbfgs', alpha=1e-5,hidden_layer_sizes=(110), random_state=1)
