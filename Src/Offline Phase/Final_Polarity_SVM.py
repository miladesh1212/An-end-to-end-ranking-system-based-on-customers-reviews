...
print('')
print('================================================================================================')
print('SVM+FrequenceFeatures')
classifier = svm.SVC(kernel='poly', degree=3, gamma='scale')
...
print('')
print('================================================================================================')
print('SVM+FrequenceFeatures+BigramFeatures+TrigramFeatures')
classifier = svm.SVC(kernel='poly', degree=3, gamma='scale')
