...
for i in range(len(U_Name)):
    ...
    for l in Matching:
        if 'RESTAURANT#GENERAL' in Aspects[l]:
            ...
            temp1 = str(id1)
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('RESTAURANT#GENERAL')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('RESTAURANT#GENERAL')]                
                dict1.update({temp2: [temp3]})
        else:
            id1+=1
            temp = {}
            temp1 = str(id1)
        ...
        if 'FOOD#QUALITY' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('FOOD#QUALITY')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('FOOD#QUALITY')]                                  
                dict2.update({temp2: [temp3]})
        else:
            id2+=1
            temp = {}
            temp1 = str(id2)
        ...
        if 'RESTAURANT#MISCELLANEOUS' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('RESTAURANT#MISCELLANEOUS')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('RESTAURANT#MISCELLANEOUS')]            
                dict3.update({temp2: [temp3]})
        else:
            id3+=1
            temp = {}
            temp1 = str(id3)
        ...
        if 'FOOD#PRICES' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('FOOD#PRICES')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('FOOD#PRICES')]            
                dict4.update({temp2: [temp3]})
        else:
            id4+=1
            temp = {}
            temp1 = str(id4)
        ...
        if 'DRINKS#QUALITY' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('DRINKS#QUALITY')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('DRINKS#QUALITY')]            
                dict5.update({temp2: [temp3]})
        else:
            id5+=1
            temp = {}
            temp1 = str(id5)
        ...
        if 'LOCATION#GENERAL' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('LOCATION#GENERAL')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('LOCATION#GENERAL')]            
                dict6.update({temp2: [temp3]})	
        else:
            id6+=1
            temp = {}
            temp1 = str(id6)
        ...
        if 'RESTAURANT#PRICES' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('RESTAURANT#PRICES')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('RESTAURANT#PRICES')]            
                dict7.update({temp2: [temp3]})	
        else:
            id7+=1
            temp = {}
            temp1 = str(id7)
        ...
        if 'AMBIENCE#GENERAL' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('AMBIENCE#GENERAL')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('AMBIENCE#GENERAL')]             
                dict8.update({temp2: [temp3]})
        else:
            id8+=1
            temp = {}
            temp1 = str(id8)
        ...
        if 'DRINKS#STYLE_OPTIONS' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('DRINKS#STYLE_OPTIONS')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('DRINKS#STYLE_OPTIONS')]            
                dict9.update({temp2: [temp3]})	
        else:
            id9+=1
            temp = {}
            temp1 = str(id9)
        ...
        if 'SERVICE#GENERAL' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('SERVICE#GENERAL')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('SERVICE#GENERAL')]            
                dict10.update({temp2: [temp3]})	
        else:
            id10+=1
            temp = {}
            temp1 = str(id10)
        ...
        if 'DRINKS#PRICES' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('DRINKS#PRICES')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('DRINKS#PRICES')]            
                dict11.update({temp2: [temp3]})	
        else:
            id11+=1
            temp = {}
            temp1 = str(id11)
        ...
        if 'FOOD#STYLE_OPTIONS' in Aspects[l]:
            ...
            temp2 = int(temp1)
            if len(Poarities[l])>1:
                [Poarities[l][Aspects[l].index('FOOD#STYLE_OPTIONS')]]
            else:
                temp3 = Poarities[l][Aspects[l].index('FOOD#STYLE_OPTIONS')]            
                dict12.update({temp2: [temp3]})	
        else:
            id12+=1
            temp = {}
            temp1 = str(id12)
        ...
        temp1 = str(i+1)
        temp2 = int(temp1);   
        Dict1.update({temp2: {1: [np.mean(list(dict1.values()))]}})
        Dict2.update({temp2: {1: [np.mean(list(dict2.values()))]}})
        Dict3.update({temp2: {1: [np.mean(list(dict3.values()))]}})
        Dict4.update({temp2: {1: [np.mean(list(dict4.values()))]}})
        Dict5.update({temp2: {1: [np.mean(list(dict5.values()))]}})
        Dict6.update({temp2: {1: [np.mean(list(dict6.values()))]}})
        Dict7.update({temp2: {1: [np.mean(list(dict7.values()))]}})
        Dict8.update({temp2: {1: [np.mean(list(dict8.values()))]}})
        Dict9.update({temp2: {1: [np.mean(list(dict9.values()))]}})
        Dict10.update({temp2: {1: [np.mean(list(dict10.values()))]}})
        Dict11.update({temp2: {1: [np.mean(list(dict11.values()))]}})
        Dict12.update({temp2: {1: [np.mean(list(dict12.values()))]}})
...
compared2best  = dict({'RESTAURANT#GENERAL':1, 'FOOD#QUALITY':2, 'RESTAURANT#MISCELLANEOUS':3,  'FOOD#PRICES':5, 'DRINKS#QUALITY':2, 'LOCATION#GENERAL':3, 'RESTAURANT#PRICES':5, 'AMBIENCE#GENERAL':3, 'DRINKS#STYLE_OPTIONS':3, 'SERVICE#GENERAL':2, 'DRINKS#PRICES':6 , 'FOOD#STYLE_OPTIONS':3});
compared2worst  = dict({'RESTAURANT#GENERAL':6, 'FOOD#QUALITY':5, 'RESTAURANT#MISCELLANEOUS':3,  'FOOD#PRICES':2, 'DRINKS#QUALITY':5, 'LOCATION#GENERAL':3, 'RESTAURANT#PRICES':2, 'AMBIENCE#GENERAL':3, 'DRINKS#STYLE_OPTIONS':3, 'SERVICE#GENERAL':5, 'DRINKS#PRICES':1 , 'FOOD#STYLE_OPTIONS':3});
...
indices = list(range(len(hotel_Scores)))
indices.sort(key=lambda x: hotel_Scores[x],  reverse = True)
Ranks = [0] * len(indices)
...
for i in range(len(hotel_Scores)):
    print("Hotel No. ",i, ":, Score: ", hotel_Scores[i], ":, Rank: ", Ranks[i]);

df = pd.DataFrame(Ranks)
writer = pd.ExcelWriter('Ranks5.xlsx', engine='xlsxwriter')
df.to_excel(writer, sheet_name='Ranks', index=False)
writer.save()
                
df = pd.DataFrame(hotel_Scores)
writer = pd.ExcelWriter('Scores5.xlsx', engine='xlsxwriter')
df.to_excel(writer, sheet_name='Scores', index=False)
writer.save() 


df = pd.DataFrame(U_Name)
writer = pd.ExcelWriter('Hnames5.xlsx', engine='xlsxwriter')
