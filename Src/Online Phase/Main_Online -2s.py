...
compared2best  = dict({'RESTAURANT#GENERAL':2, 'FOOD#QUALITY':3, 'RESTAURANT#MISCELLANEOUS':9,  'FOOD#PRICES':2, 'DRINKS#QUALITY':5, 'LOCATION#GENERAL':8, 'RESTAURANT#PRICES':1, 'AMBIENCE#GENERAL':7, 'DRINKS#STYLE_OPTIONS':6, 'SERVICE#GENERAL':5, 'DRINKS#PRICES':3 , 'FOOD#STYLE_OPTIONS':4});
compared2worst  = dict({'RESTAURANT#GENERAL':8, 'FOOD#QUALITY':7, 'RESTAURANT#MISCELLANEOUS':1,  'FOOD#PRICES':8, 'DRINKS#QUALITY':5, 'LOCATION#GENERAL':2, 'RESTAURANT#PRICES':9, 'AMBIENCE#GENERAL':3, 'DRINKS#STYLE_OPTIONS':4, 'SERVICE#GENERAL':5, 'DRINKS#PRICES':7 , 'FOOD#STYLE_OPTIONS':6});
...
writer = pd.ExcelWriter('Ranks2.xlsx', engine='xlsxwriter')
df.to_excel(writer, sheet_name='Ranks', index=False)
writer.save()

df = pd.DataFrame(hotel_Scores)
writer = pd.ExcelWriter('Scores2.xlsx', engine='xlsxwriter')
df.to_excel(writer, sheet_name='Scores', index=False)
writer.save()

df = pd.DataFrame(U_Name)
writer = pd.ExcelWriter('Hnames2.xlsx', engine='xlsxwriter')
